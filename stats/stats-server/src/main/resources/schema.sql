-- Таблица статистики (живет в stats-server)
CREATE TABLE IF NOT EXISTS hits (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    app VARCHAR(255) NOT NULL,
    uri VARCHAR(512) NOT NULL,
    ip VARCHAR(45) NOT NULL, -- IPv6 может быть до 45 символов
    timestamp TIMESTAMP WITHOUT TIME ZONE NOT NULL
);

-- Индексы для stats-server
...
CREATE INDEX IF NOT EXISTS idx_hits_app_uri_timestamp ON hits(app, uri, timestamp);